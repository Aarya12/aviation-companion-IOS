...
@IBDesignable class RollingPitTabBar: UITabBar {
    ...
    @IBInspectable public var barBackColor : UIColor = UIColor(red: 0.578, green: 0.63, blue: 0.746, alpha: 0.3)
    @IBInspectable public var barHeight : CGFloat = 50
    @IBInspectable public var barTopRadius : CGFloat = 25
    @IBInspectable public var barBottomRadius : CGFloat = 25
    
    @IBInspectable public var circleBackColor : UIColor = UIColor.clear
    @IBInspectable public var circleRadius : CGFloat = 25
    
    @IBInspectable var marginBottom : CGFloat = 20
...
//        animation.beginTime = CACurrentMediaTime() + 2
    ...
    override var selectedItem: UITabBarItem? {
        get{
            return super.items?[2] //super.selectedItem
        }
        set{
